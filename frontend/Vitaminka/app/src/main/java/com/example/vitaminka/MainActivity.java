...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppBarConfiguration appBarConfiguration = new AppBarConfiguration.Builder(
                R.id.navigation_home, R.id.navigation_catalog, R.id.navigation_profile, R.id.navigation_profile_likes, R.id.navigation_profile_login, R.id.navigation_profile_registration, R.id.navigation_profile_cart, R.id.navigation_drug_list)
                .build();
