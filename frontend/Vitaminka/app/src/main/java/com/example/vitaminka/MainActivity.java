...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppBarConfiguration appBarConfiguration = new AppBarConfiguration.Builder(
                R.id.navigation_home, R.id.navigation_catalog, R.id.navigation_catalog_orthopedic, R.id.navigation_catalog_orthopedic_massagers, R.id.navigation_catalog_orthopedic_massagers_filters)
                .build();
